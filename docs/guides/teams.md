...
In order to learn more about the advantages of 2FA and how to set it up for your pretix user account, read our article on [Two-factor authentication](two-factor-authentication.md).
