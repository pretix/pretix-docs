...
Die Einrichtung von Zahlungsdienstleistern erfolgt auf Event-Ebene, daher müssen Sie zunächst ein Event erstellen.
...
Die Einrichtung von PayPal als Zahlungsdienstleister in pretix umfasst folgende Schritte:
...
Wechseln Sie zum Tab :btn:Zahlungsdienstleister:.
...
Der Tab :btn:Zahlungsmethoden: auf dieser Seite zeigt die Liste der aktiven Zahlungsdienstleister.
Die Liste sollte nun einen Eintrag für PayPal mit einem roten ":fa3-remove: Deaktiviert"-Badge enthalten.
Das Plugin ist aktiviert, aber PayPal wurde noch nicht als Zahlungsdienstleister für das Event eingerichtet und freigeschaltet.
...
Das Plugin ist aktiv, aber PayPal wurde noch nicht als Zahlungsdienstleister für das Event eingerichtet.
...
Sehen Sie sich die Seite genau an und aktivieren Sie alle Einstellungen, die Sie für diesen Zahlungsdienstleister bei Ihrem Event nutzen möchten.
