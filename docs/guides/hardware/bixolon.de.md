...
Bei diesem Artikel handelt es sich um eine Schnellstart-Anleitung für die Verwendung des Druckers Bixolon XD5-40d oder vergleichbarer Geräte zusammen mit pretix.
...
!!! Note
    Wir empfehlen, den Drucker über LAN zu verbinden.
    Eine Kabelverbindung ist zuverlässiger als WLAN.
...
Für die Verbindung des Druckers mit dem Netzwerk über **WLAN** gibt es zwei Möglichkeiten.
Falls Sie einen Bixolon XD5-40d verwenden, müssen Sie nichts weiter unternehmen.
Falls Sie eines der vergleichbaren Modelle verwenden, das nicht über ein eingebautes WLAN-Modul verfügt, dann haben wir Ihnen einen WLAN-Dongle mitgeliefert.
Stecken Sie den WLAN-Dongle in die USB-A-Buchse an der Rückseite des Druckers.
...
Der Etikettendrucker Bixolon XD5-40d hat zwischen dem USB- und Ethernet-Anschluss ein kleines Loch, in dem ein Button verborgen ist.
Bei den Mietgeräten ist dieses Loch mit einem pfeilförmigen Aufkleber markiert.
