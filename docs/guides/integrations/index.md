...
You can find information on selling pretix products via GetYourGuide under [GetYourGuide](getyourguide.md). 

You can find information on setting up automatic data export to HubSpot under [HubSpot](hubspot.md). 

You can find information on setting up presale SAML authentication under [Presale SAML authentication](presale-saml.md). 
