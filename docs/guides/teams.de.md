...
Sie können die Mitglieder eines Teams und die API-Tokens ansehen, indem Sie den Button :btn-icon:fa3-list:: rechts neben dem Teamnamen klicken.
Die Berechtigungen und Einstellungen für ein Team können Sie einsehen und ändern, indem Sie den Button :btn-icon:fa3-edit:: anklicken.
...
Wenn Sie unterschiedliche Berechtigungen für andere Veranstaltungen vergeben möchten, dann legen Sie ein neues Team an. 
...
Die Person wird entweder mit einem grauen oder grünen Schildsymbol :fa3-shield: rechts neben der E-Mail-Adresse aufgelistet, abhängig davon, ob diese die Zwei-Faktor-Authentifizierung aktiviert hat oder nicht.
...
Sie werden daraufhin zum Dashboard weitergeleitet, das folgende Nachricht anzeigt: "Willkommen zu pretix! Sie sind nun Mitglied vom Team "Mitarbeiter*innen".
...
## Zwei-Faktor-Authentifizierung erfordern

Sie können alle Mitglieder eines Teams dazu verpflichten, die Zwei-Faktor-Authentifizierung zu verwenden.
Dazu bearbeiten Sie ein Team oder legen Sie ein neues an.
Aktivieren Sie das Kontrollkästchen "Alle Mitglieder dieses Teams müssen Zwei-Faktor-Authentifizierung nutzen" und klicken Sie den Button :btn:Speichern:. 
Es kann ein paar Minuten dauern, bis diese Einstellung wirksam wird.
