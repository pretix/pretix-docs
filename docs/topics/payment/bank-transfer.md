...
Navigate to :btn:Your Event → Settings → Plugins:. 
...
You can intervene and make manual corrections here on this screen or by navigating to :navpath:Your Event → Orders:. 
