...
We will now open pretix.eu, navigate to our event, and click :btn-icon:fontawesome-solid-cart-shopping: Orders: in the sidebar. 
...
For that, we will navigate to our event and click the :btn-icon:fontawesome-solid-triangle-exclamation: TEST MODE: entry in the sidebar which is highlighted in orange. 
