...
We are going to sell tickets for the regular opening hours of that museum and for guided tours.
...
Here is a brief overview of the steps we are going to take in this tutorial:
 ...
 - creating [dates](dates.md) within our event series (regular opening hours and guided tours)
...
This takes us to a site on which we will enter the info for our personal pretix account in the left column, and the name and short form for our organizer in the right column.
