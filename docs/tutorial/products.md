...
After having created all the admission products we need,we will now create a sticker product with multiple variations to reflect different colors: purple, black, and glitter. 
...
Since we still need quotas for the other variants of the product, e will navigate back to "Quotas" and click the "clone" button next to the sticker quota we just created. 
