...
HTTP connections to local networks (like 127.0.0.1 or 10.0.0.0) are now blocked by default to prevent unauthorized access to internal services by backend users.
